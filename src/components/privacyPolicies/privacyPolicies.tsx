...
const privacyPoliciesComponent: React.FC = (): JSX.Element => {
  return (
    <div>
      <strong>Privacy Policy</strong>{' '}
      <p>
        Deft built the Placa y Cédula Colombia app as a Free app. This SERVICE is
        provided by Deft at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        and Conditions, which is accessible at Placa y Cédula Colombia unless
      ...
      <p>
        ...
        not limited to deftsoluciones@gmail.com. The information that we request will
      ...
      <p>
        ...
        hesitate to contact us at deftsoluciones@gmail.com.
      </p>{' '}
      <p>
...
export { privacyPoliciesComponent }
